...
|BHKV1044|Blokkerend|Een @wordt-versie in een besluit MOET gelijk zijn aan precies één meegeleverde FRBRExpression-identificatie in de data:regelingversieinformatie.|
|BHKV1046|Blokkerend|Procedurestap Publicatie MAG NIET aangeleverd worden.|
|BHKV1047|Blokkerend|Bij een definitief besluit MOGEN ALLEEN de volgende procedurestappen voorkomen: VaststellingOndertekeningEinde BezwaartermijnEinde Beroepstermijn|
|BHKV1048|Blokkerend|Een definitief besluit MOET de procedurestap Ondertekening hebben.|
|BHKV1049|Blokkerend|Bij een ontwerpbesluit MOGEN ALLEEN de volgende procedurestappen voorkomen:VaststellingOndertekeningBegin InzagetermijnEinde Inzagetermijn|
...
|LVBB1006|Blokkerend|Valideert opdracht.xml tegen schema?|
|LVBB1008|Blokkerend|Valideert manifest.xml tegen schema?|
|LVBB1009|Blokkerend|Zijn alle bestanden genoemd in manifest aanwezig in zip?|
|LVBB1010|Blokkerend|Worden alle bestanden aanwezig in zip genoemd in manifest?|
|LVBB1012|Blokkerend|Is de combinatie OIN id en leveringId uniek?|
|LVBB1013|Blokkerend|Plaatjes mogen geen transparantie hebben|
|LVBB1015|Blokkerend|Valideert manifest-ow.xml tegen schema?|
|LVBB1016|Blokkerend|Zijn alle bestanden genoemd in manifest-ow aanwezig in zip?|
|LVBB1017|Blokkerend|Is het bestandsformaat van de afbeelding een formaat dat ondersteund wordt?|
|LVBB1018|Blokkerend|Komt het gespecificeerde contenttype van een afbeelding overeen met het werkelijke contenttype?|
|LVBB1019|Blokkerend|Komt het gespecificeerde contenttype voor in de lijst met toegestane mimetypes?|
|LVBB1020|Blokkerend|Is het aangeleverde contenttype ingevuld?|
|LVBB1021|Blokkerend|Komt het gespecificeerde contenttype overeen met het werkelijke contenttype?|
...
|LVBB1027|Blokkerend|Bestand manifest-ow.xml MOET aanwezig zijn in het aangeleverde zip-bestand bij:- "validatieOpdracht" van een besluit;- "publicatieOpdracht" van een besluit;- "valideerRegelingVersie";- "registreerRegelingVersie";- "valideerDoorleverenRegelingVersie";- "doorleverenRegelingVersie"|
...
|LVBB1032|Blokkerend|Valideert manifest-bhkv.xml tegen schema?|
|LVBB1033|Blokkerend|Zijn alle bestanden genoemd in manifest-bhkv aanwezig in zip?|
...
|LVBB1039|Blokkerend|Worden alle bestanden aanwezig in zip genoemd in manifest-bhkv?|
...
|LVBB2003|Blokkerend|Valideert het document tegen het imop schema?|
...
|LVBB3004|Blokkerend|Kan MarkLogic de gml opslaan?|
|LVBB3008|Blokkerend|Klopt de meegeleverde hash met de zelf berekende hash voor informatie-objecten|
|LVBB3009|Blokkerend|Valideert het gml document tegen het schema bij Geometrie?|
|LVBB3010|Blokkerend|Valideert het gml document tegen het schema bij BasisGeometrie?|
...
|LVBB3501|Blokkerend|Valideert het document tegen de versie-informatie bij het io schema?|
...
|LVBB3508|Blokkerend|De aangeleverde IO's mogen niet bestaan|
...
|LVBB4007|Blokkerend|soortProcedure van de eerste RegelingMetadata in een besluit moet beginnen met '/join/id/stop/regelingtype_0' (zodat van daaruit later juiste waardes kunnen worden bepaald)|
...
|LVBB4204|Blokkerend|Als de was-versie geen 'datum JWV' heeft dan moet de wordt-versie ook geen 'datum JWV' hebben.|
...
|LVBB7501|Blokkerend|Valideert de RegelingVersie tegen het imop schema?|
|LVBB7502|Blokkerend|Valideert de Consolidaties tegen het imop schema?|
|LVBB7503|Blokkerend|Valideert de UitleveringProefversiebesluit tegen het imop schema?|
|LVBB7504|Blokkerend|Valideert de WTI (WetTechnischeInformatie) tegen het imop <?> schema?|
...
|LVBB8001|Blokkerend|Valideert de OfficielePublicatie tegen het imop schema?|
...
|STOP0001|Blokkerend|Een Lijst van het type 'ongemarkeerd' MAG GEEN lijst-items met nummering of symbolen hebben|
|STOP0002|Blokkerend|Een Lijst van het type 'expliciet' MOET lijst-items hebben met nummering of symbolen|
...
|STOP0039|Blokkerend|Een element WijzigInstructies MAG alleen voorkomen in een BesluitKlassiek|
...
|STOP0051|Blokkerend|Een element OpmerkingVersie MAG alleen in een BesluitKlassiek worden gebruikt|
...
|STOP0063|Blokkerend|tekst:Inhoud mag uitsluitend een @wijzigactie hebben gecombineerd met tekst:Vervallen; tekst:Gereserveerd of tekst:Lid.|
...
|STOP1060|Blokkerend|Een verwijzing naar een geboorteregeling MOET naar een expression van een Regeling die begint met /akn/nl/act/... verwijzen.|
...
|STOP2019|Blokkerend|De ConsolidatieInformatie van een BeoogdeRegeling MOET verwijzen naar waar in de juridische tekst staat dat deze nieuwe versie; juridisch gezien; ontstaat. In het klassieke model is dit binnen tekst:RegelingKlassiek; maar niet binnen tekst:wijzigArtikel of tekst:RegelingKlassiek zelf. In het compacte model is dit binnen tekst:Artikel van tekst:Lichaam van tekst:BesluitCompact(Besluit) of tekst:BesluitMutatie(Rectificatie).|
|STOP2020|Blokkerend|Een Tijdstempel in de Consolidatieinformatie MOET verwijzen naar waar in de juridische tekst de tijdstempel; juridische gezien; ontstaat. In het klassieke model is dit binnen een tekst:Artikel. In het compacte model is dit binnen een tekst:Artikel van tekst:Lichaam van tekst:BesluitCompact (Besluit) of tekst:BesluitMutatie(Rectificatie).|
|STOP2021|Blokkerend|Een Intrekking van een Regeling in de Consolidatieinformatie MOET verwijzen naar waar in de juridische tekst de Regeling; juridisch gezien; wordt ingetrokken. In het klassieke model is dit binnen een tekst:Artikel In het compacte model is dit binnen een tekst:Artikel van tekst:Lichaam van tekst:BesluitCompact(besluit) of tekst:BesluitMutatie(rectificatie).|
...
|STOP2050|Blokkerend|De tekstmodule bij een data:ExpressionIdentificatie met data:soortWork '/join/id/stop/work_003' MOET een root-element tekst:BesluitCompact of tekst:BesluitKlassiek hebben.|
|STOP2051|Blokkerend|De tekstmodule bij een data:ExpressionIdentificatie met data:soortWork '/join/id/stop/work_019' MOET een root-element tekst:RegelingCompact; tekst:RegelingKlassiek of tekst:RegelingVrijetekst hebben.|
...
|TPOD2210|Blokkerend|De combinatie van Doel en Regeling uit het manifest-OW moet ook als combinatie bestaan in OP|
